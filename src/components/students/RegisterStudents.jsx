...
import '../../style/registerStudents.css'
...
const RegisterStudents = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await Api.register(
                JSON.stringify({ name,email,username, pwd,role:'student' ,gender,session,stage})
                );
            swal({
                title: `Done`,
    ...
    return (
        <>
            <section className="registerStudent-holder">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='gender'>
                        ...
                        <label htmlFor="session">
                            Session :
                            <input onChange={(e)=>{ setSession(e.target.value)}} type="text" />
                        </label> 
                    </div>
                    {/* --------------------------------------- stage---------------------------------------- */}
                    <div className='stage'>
                        <label htmlFor="stage">
                            Stage :
                            <select onChange={(e)=>{setStage(e.target.value)}} name="stage" className="select-stage" id="">
